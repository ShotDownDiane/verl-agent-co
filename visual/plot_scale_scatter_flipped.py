...
def parse_and_plot_flipped_scatter():
    # Read raw data
    ...
    for i, city in enumerate(cities):
        ...
        # Arrow annotation - UPDATED for INVERTED Y-AXIS
        # "Better" means Lower Obj (Top) and Lower Time (Left) -> Top-Left
        ax.annotate(
            "Better", 
    ...
    plt.suptitle("Scalability Analysis: Objective vs Time (Inverted Y-Axis)", fontsize=22, fontweight='bold', y=1.05)
    
    output_path = '/root/autodl-tmp/rl4co-urban/visual/scale_scatter_flipped.png'
    plt.savefig(output_path, dpi=300, bbox_inches='tight')
    print(f"Flipped scatter plot saved to {output_path}")

if __name__ == "__main__":
    parse_and_plot_flipped_scatter()
