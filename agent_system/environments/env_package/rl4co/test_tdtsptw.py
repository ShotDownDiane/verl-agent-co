...
def test_tdvrp_greedy_full():
    ...
    for base_file in unique_bases:
        print(f"  >>> Sub-group: {base_file}")
        ...
        manager = WorkerManager(env_name="tdtsp_tw")

        for current_idx in trange(0, num_samples-1, batch_size, desc="Full Trajectory Loop"):
            ...
            for info in infos:
                ...
                final_cum_reward = final_cum_reward * 3600
