...
if __name__ == '__main__':
    ...
    model = PPO("MlpPolicy", env, verbose=1, batch_size=128, learning_rate=0.001, device='cpu',
                seed=seed)
    callback = SaveOnBestTrainingRewardCallback(check_freq=100, my_log_dir=log_dir, my_modelname=modelname)
