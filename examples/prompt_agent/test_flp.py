...
def main():
    ...
    print("\n" + "="*50)
    print("1. Single Worker Execution (FLP) with RL4COEnvironmentManager")
    print("="*50)

    flp_data = graph_data['flp']
    n = len(flp_data)
    if n == 0:
        print("No FLP instances.")
        return
    ...
    for i in range(0, num_to_run, batch_size):
        ...
        projection_f = partial(co_projection_selected, env_name="flp")
